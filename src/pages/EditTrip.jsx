...
// Works and puts information in boxes, but not the activities
// because of search box issue
//
// import { signOut } from 'firebase/auth';
// import { auth, db } from '../components/firebase';
// import { useNavigate } from 'react-router-dom';
...
//             );
//             setSelectedOutdoor(tripData.preferences?.selectedOutdoor || []);
//             setDisplayedCost({ cost: tripData.cost || '0' });
//           }
//         } catch (error) {
//           console.error('Error fetching trip to edit:', error);
//         }
...
// Works, but does not put information, leaves stuff blank
//
// import { signOut } from 'firebase/auth';
// import { auth, db } from '../components/firebase';

...
//                   createdAt: tripData.createdAt.toDate(), // Convert Timestamp to Date
//                   entertainmentCount: tripData.preferences?.selectedEntertainment?.length || 0,
//                   foodCount: tripData.preferences?.selectedFoods?.length || 0,
//                   outdoorCount: tripData.preferences?.selectedOutdoor?.length || 0,
//                 };
//               }
//               return null;
//             })
...
//           setTripsData(trips.filter(trip => trip !== null)); // Filter out null results
//         }
//       } catch (error) {
//         console.error('Error fetching trips:', error);
//       }
...
//                         <td>{trip.destination}</td>
//                         <td>{trip.duration}</td>
//                         <td>{trip.entertainmentCount}</td>
//                         <td>{trip.foodCount}</td>
//                         <td>{trip.outdoorCount}</td>
//                         <td>{trip.createdAt.toLocaleDateString()}</td>
//                         <td>
//                           <button onClick={() => navigate(`/edit/${trip.id}`)}>Edit</button>
//                         </td>
//                       </tr>
//                     ))}
//                   </tbody>
